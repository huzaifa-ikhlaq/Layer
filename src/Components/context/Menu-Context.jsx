            ...
            <div className="max-w-[27%] h-140 px-[15px] rounded-lg overflow-y-scroll">
                ...
                {cart.length === 0 && (
                    <div className='flex flex-col justify-center h-full '>
                        <span>
                            <svg className='h-24 w-full mt-3 mb-5' xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 16 16">
                                <g fill="#77777719" strokeWidth="0" stroke="#77777719">
                        ...
                        <p className='text-[#777777] font-medium text-center'>
                            You must have an order with the minimum of
                            <span className='text-[#b09c6d] font-bold'> Rs 1,000</span> to place your order, your current order total is
                            <span className='text-[#b09c6d] font-bold'> Rs 0</span>.
                        </p>
                    </div>
                )}

                {cart.map(item => (
                    <div key={item.id} className="mb-4 mt-9">
                        ...
                        <hr className='text-[#77777743] my-4' />
                    </div>
                ))}

                {/* total */}
                {cart.length > 0 && (
                    <div className="flex justify-between mt-3 text-[17px] font-semibold border-b border-[#77777743] pb-4 mb-2">
                        <span>Subtotal:</span>
