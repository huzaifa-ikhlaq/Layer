...
export default function CakesOption() {

    const { allProducts, cart, CartSection, handleAddToCart, handleQuantity } = useContext(LayerContext)

    const cakesMenu = allProducts.filter((product) => product.category === "Cakes");
                    ...
                    <div key={product.id} className="mx-[15px] mb-7.5">
                        ...
                        <div>
                            ...
                            <img
                                ...
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZpzr5ZFbZCdOOU47NqqfQKAjAb48gbumZHg&s"
                                alt={product.name}
                            />
