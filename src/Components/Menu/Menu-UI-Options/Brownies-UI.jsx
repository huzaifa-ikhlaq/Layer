...
export default function BrowniesOption() {
    ...
    const browniesMenu = allProducts.filter((product) => product.category === "Brownies")
                    ...
                    <div key={product.id} className="mx-[15px] mb-7.5">
                        ...
                        <div>
                            ...
                            <img
                                ...
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7YCrKXxObfSfkwE5LBe4rq3LdudVu9fXbUw&s"
                                alt={product.name}
                            />
