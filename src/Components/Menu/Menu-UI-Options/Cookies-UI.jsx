...
export default function CookiesOption() {
    ...
    const cookiesMenu = allProducts.filter((product) => product.category === 'Cookies')
                    ...
                    <div key={product.id} className="mx-[15px] mb-7.5">
                        ...
                        <div>
                            ...
                            <img
                                ...
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3cVQICsBL6_lMmdIaSwcYUdneIwvX0naFIQ&s"
                                alt={product.name}
                            />
