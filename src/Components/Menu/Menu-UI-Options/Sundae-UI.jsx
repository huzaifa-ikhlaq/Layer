...
export default function SundaeOption() {

    const { sundaesMenu } = useContext(LayerContext)
    ...
    return (
        <div className='flex'>
            ...
            <div className="grid grid-cols-4 w-[73%] px-[15px]">
                {sundaesMenu.map((sundae) => (
                    <div key={sundae.id} className='mx-[15px] mb-7.5'>
                        {/* product */}
                        <div>
                            {/* Image */}
                            <img
                            ...
                            <p className="text-[17px] text-[#777777]">{sundae.description}</p>
                            ...
                            <div className="flex flex-col gap-5 justify-between mt-6">
                                <span className="text-[#b09c6d] text-[17px] font-bold">
                                    {sundae.currency}{" "}
                                    <span className="font-semibold">{sundae.price}</span>
                                </span>
                                {/* add to cart area  */}
                                <span className="flex items-center  gap-2">
                                    ...
                                    {/* Add to cart  */}
                                    <button className='bg-[#b09c6d] hover:bg-[#a5905f] text-white text-sm font-semibold cursor-pointer  transition-all duration-400  h-10.5 w-28  '>Add to Cart</button>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            {/* cart */}
            <div className="w-[27%] px-[15px] bg-cyan-950"></div>
        </div>
    )
}